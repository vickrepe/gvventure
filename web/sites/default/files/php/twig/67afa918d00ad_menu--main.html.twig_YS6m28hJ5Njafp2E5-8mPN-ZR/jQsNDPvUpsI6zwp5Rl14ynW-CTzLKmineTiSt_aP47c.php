...
/* themes/custom/gvventure_barrio/templates/navigation/menu--main.html.twig */
class __TwigTemplate_893ca30f71059fd241975a0adf13729c extends Template
{
        ...
        return ('' === $tmp = \Twig\Extension\CoreExtension::captureOutput((function () use (&$context, $macros, $blocks) {
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 33
                    yield "      <ul";
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->withoutFilter(CoreExtension::getAttribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", ["nav navbar-nav"], "method", false, false, true, 33), "id"), "html", null, true);
                    yield ">
    ";
                } else {
                    // line 35
...
$context["item"], "url", [], "any", false, false, true, 53), "getOption", ["attributes"], "method", false, false, true, 53), "class", [], "any", false, false, true, 53)) ? (Twig\Extension\CoreExtension::join(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["item"], "url", [], "any", false, false, true, 53), "getOption", ["attributes"], "method", false, false, true, 53), "class", [], "any", false, false, true, 53), " ")) : ("")), ("nav-link-" . \Drupal\Component\Utility\Html::getClass(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source,                     // line 54
$context["item"], "url", [], "any", false, false, true, 54), "toString", [], "method", false, false, true, 54)))];
                    // line 57
                    yield "        ";
                    if (CoreExtension::getAttribute($this->env, $this->source, $context["item"], "below", [], "any", false, false, true, 57)) {
                        // line 58
                        yield "          ";
                        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->getLink(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "title", [], "any", false, false, true, 58), CoreExtension::getAttribute($this->env, $this->source, $context["item"], "url", [], "any", false, false, true, 58), ["class" => ($context["link_classes"] ?? null), "data-bs-toggle" => "dropdown", "aria-expanded" => "false", "aria-haspopup" => "true"]), "html", null, true);
                        yield "
          ";
                        // line 59
        ...
        ";
                        ...
                        // line 61
                        yield "          ";
                        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->getLink(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "title", [], "any", false, false, true, 61), CoreExtension::getAttribute($this->env, $this->source, $context["item"], "url", [], "any", false, false, true, 61), ["class" => ($context["link_classes"] ?? null)]), "html", null, true);
                        yield "
        ";
                    }
                    // line 63
  ...
  ";
    ...
    {
        return "themes/custom/gvventure_barrio/templates/navigation/menu--main.html.twig";
    }
    ...
    {
        return array (  143 => 65,  136 => 63,  130 => 61,  125 => 59,  120 => 58,  117 => 57,  115 => 54,  114 => 53,  113 => 52,  112 => 51,  111 => 50,  110 => 49,  105 => 47,  103 => 44,  102 => 43,  101 => 42,  100 => 41,  99 => 40,  98 => 39,  96 => 38,  91 => 37,  87 => 35,  81 => 33,  78 => 32,  75 => 31,  72 => 30,  58 => 29,  49 => 27,  46 => 22,  44 => 21,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "themes/custom/gvventure_barrio/templates/navigation/menu--main.html.twig", "/var/www/html/web/themes/custom/gvventure_barrio/templates/navigation/menu--main.html.twig");
    }
